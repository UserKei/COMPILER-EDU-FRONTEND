<template>
  <div
    ref="nodeRef"
    class="min-w-24 min-h-16 bg-white border-2 border-gray-300 rounded-xl p-3 transition-all duration-200 relative cursor-default group hover:border-blue-400 hover:shadow-lg"
    :class="{
...
<style scoped>
/* Remove all handle hiding - let Vue-Flow handles work normally */
</style>
