  ...
  <div class="grammar-input-step">
    ...
    <div class="step-content">
      <div class="text-center py-20">
        ...
        <p class="text-gray-500">文法输入组件正在开发中...</p>
      </div>
    </div>
    ...
    <div class="step-actions">
      <div class="flex justify-between items-center">
        ...
        <button @click="nextStep" class="px-6 py-2 bg-pink-600 text-white rounded-lg hover:bg-pink-700 transition-colors">
          下一步
...
const nextStep = () => {
  ...
  localStorage.setItem('slr1-step1-data', JSON.stringify(stepData))
  emit('next-step')
}
</script>
...
.step-icon { width: 3rem; height: 3rem; background: #fce7f3; border-radius: 0.75rem; display: flex; align-items: center; justify-content: center; }
